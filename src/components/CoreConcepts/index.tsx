    ...
    return (
      <section>
        ...
        <TextList>
          ...
          <TextList.Item>How to organize file structure of React project</TextList.Item>
          <TextList.Item>
          ...
          <TextList.Item>How to setup strightforward CI/CD pipeline with TravisCI and Surge.sh</TextList.Item>
          <TextList.Item>
